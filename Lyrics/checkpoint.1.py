...
'''
a sort of wrapper for the original swear word locator.
defines functions required to retrieve data and surrounding logic.
'''
...
def SortArtist (Nam) :
    ...
    while(placeSt > 10) :
        ...
        global calls
        if(calls >= 6):                                # manage the calls made no mare than few threads a time
            calls = 0
            time.sleep(0.5)                              # to fool the server into thinking that the data is being requested by human
